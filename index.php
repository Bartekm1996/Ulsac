...
<div id="hide_privacy" class="mt-sm-5 pt-5 col-12 col-sm-8 offset-sm-2 col-lg-6 offset-lg-3">
    <div class="card mt-5">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <!--[if lte IE 9]>
                <h3 class="col-12 text-center">Notice: This website is incompatible with your version of Internet Explorer.</h3>
...
<!--[if !IE]><!-->
<div id="show_privacy" class="d-none mt-5 pt-5 col-12 col-lg-10 offset-lg-1">
    <div class="card mt-5">
        <div class="card-body">
            ...
            <div class="my-2">
                <h1 class="text-center">UL Wolves Privacy Policy</h1>
            </div>
...
<p>When setting up a Clubs & Society UL Wolves account, we will collect and gather the following categories of personal data,</p>
...
<h2>Existing Data Information with Clubs & Societies (UL Wolves)</h2>
...
<p><b>Any complaints with regard to this policy should be directed to:</b></p>
<p>Martin Ryan,<br>
General Manager, <br>
UL Student Life<br>
University of Limerick<br>
...
<p>Or to apply for review by the Court pursuant to the Data Protection Act, 2018.</p>
                <div class="text-center col-12">
                    <div id="enable_2"> 
                        <h3>Please enable javascript and cookies on your web browser and refresh this page in order to continue to UL Wolves.</h3>
                    </div>
                    <button id="accept_2" class="d-none btn btn-lg btn-primary">Agree and continue to UL Wolves</button>
                </div>
            </div>
...
<div class="text-center text-white my-3 my-sm-5">
    <a class="btn btn-sm btn-secondary" onclick="show_privacy()" href="#">UL Wolves Privacy Policy</a>
</div>
<!--<![endif]-->
...
<script>
    function show_privacy() {
        document.getElementById('hide_privacy').classList.add('d-none');
        document.getElementById('show_privacy').classList.remove('d-none');
    }

    var accept_1 = document.getElementById('accept_1');
    var enable_1 = document.getElementById('enable_1');
    var accept_2 = document.getElementById('accept_2');
    var enable_2 = document.getElementById('enable_2');

    if (navigator.cookieEnabled) {
        enable_1.classList.add('d-none');
        accept_1.classList.remove('d-none');
        enable_2.classList.add('d-none');
        accept_2.classList.remove('d-none');
    }

    var now = new Date();
    now.setTime(now.getTime() + 86400000 * 30); // 30 days

    window.cookie_info = "Confirm_Privacy=true; expires=" + now.toUTCString() + "; domain=.ulwolves.ie; path=/;";

    accept_1.addEventListener('click', function() {

        document.cookie = window.cookie_info;
        location.reload();
    ...
    accept_2.addEventListener('click', function() {
        ...
        <div class="d-none"><img id="next_bg_L" class="d-none" src="https://cdn.ulwolves.ie/img/_rotating/2019-08-14/landscape/Club American football Action Shot High Res.JPG"></div>

            <div class="d-none"><img id="next_bg_P" class="d-none" src="https://cdn.ulwolves.ie/img/_rotating/2019-08-14/portrait/Basketball & Wolf.jpg"></div>
    ...
    function set_which_orientation() { 
    ...
    set_which_orientation();
    window.addEventListener("resize", set_which_orientation);

    if (typeof(window.bgs) != 'undefined' && typeof(window.bgs[1]) != 'undefined') {

        window.num_bgs = window.bgs.length-1
        window.current_bg = 0;
        window.first_run = true;

        function change_bg() {
            if (window.current_bg < window.num_bgs) {
                window.current_bg++;
            } else {
            ...
            if (window.first_run && (window.current_bg < (window.num_bgs))) {
                document.getElementById(next_bg).src = url+window.bgs[window.current_bg+1];
            } else if (window.first_run) {
                document.getElementById(next_bg).parentNode.removeChild(document.getElementById(next_bg));
            }
